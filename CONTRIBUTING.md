...
The [`release-ghcr.yml`](.github/workflows/release-ghcr.yml) workflow
publishes `ghcr.io/vakaobr/iac-cartographer` on every tag push, plus a
rolling `:main` tag on every main push.
